...
from dataloaders.WSI_Loader import ubc_ocean_dataloader
...
if __name__ == '__main__':
    ...
    wsi_loader_fold_1_train = ubc_ocean_dataloader(h5_dir=h5_dir_fold_1_train, wsi_dir=wsi_dir_fold_1_train)
